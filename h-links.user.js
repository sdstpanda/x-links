...
(function () {
	...
	Options = {
		...
		init: function () {
			Main.insert_nav_link("main", "H-links", "H-links Settings", " hl-nav-link-settings", Options.open);
		}
	};
	Config = {
		namespace: "hlinks-settings",
