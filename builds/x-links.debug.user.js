	...
	var Main = (function () {
		...
		var on_ready = function () {
			...
			if (config.general.compatibility_check) {
				setTimeout(function () { run_compatibility_check(); }._w(720), 1000);
			}
